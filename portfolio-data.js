...
//
//  ✏  HOW TO UPDATE YOUR LIVE PORTFOLIO:
...
//  It is loaded by both index.html (display) and admin.html (messages).
// ═══════════════════════════════════════════════════════════════
...
const PORTFOLIO = {
  ...
  profile: {
    ...
    profilePhoto:   '',                // paste a base64 image or leave '' for emoji
  },
...
ML systems — turning raw data into intelligent, impactful products.`,
  ...
  // ── PROJECTS ────────────────────────────────────────────────
  // github and live must be real URLs — leave '' to hide the button
  projects: [
    {
